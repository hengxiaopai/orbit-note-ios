...
v0.2 can move into SwiftData persistence after a real Xcode build passes. The recommended order is: SwiftData local store, migration of mock data into seed fixtures, notification permission flow, Widget timeline provider, Share Extension image rendering, App Intents, then optional Jitter/Lottie assets.
